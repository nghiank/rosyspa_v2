...
function SendMail($frommail,$tomail,$subject,$message,$fromfullname="Sindre Design")
{
      ...
      $smtp_host ='mail.berosy.vn';//Dia chi mail server
      $admin_email = 'none@berosy.vn';//User duoc khai bao tren mail server
      $smtp_username = 'spa@berosy.vn';//User duoc khai bao tren mail server
      $smtp_password = 'myredrose';//Pass cua email nay
